...
function Track({ track, chooseTrack}) {
  ...
  return (
    <div className="flex items-center justify-between space-x-20 cursor-default hover:bg-white/ 10
    py-2 rounded-lg group transition ease-out">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-[rgb(179,179,179)] text-[13px] font-semibold
        ...
        <div className="md:ml-auto flex items-center space-x-2.5">
          <div className="text-white flex space-x-1 text-sm front-semibold">
